...
define('token', "1270663332:AAG3hOHpcJv0IYK4CoJ7uL2mfqjhlhN4rwQ");
 ...
 */
  switch ($cmd) {
  	case "/start":
  		...
  		"Questo è il bot di ingegneria energetica nel quale sono presenti tutti i gruppi Telegram relativi ai corsi";
